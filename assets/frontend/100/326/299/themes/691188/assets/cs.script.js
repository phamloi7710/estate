...
// 		+					'</div>'
// 		+				'</div>'
// 		+ 				'<button class="btn btn-block btn-outline-main" data-dismiss="modal">Tiáº¿p tá»¥c mua hĂ ng</button>'
// 		+ 				'<a href="/checkout" class="btn btn-block btn-primary">Tiáº¿n hĂ nh thanh toĂ¡n Â»</a>'
// 		+			'</div>'
// 		+		'</div>'
// 		+	'</div>';
