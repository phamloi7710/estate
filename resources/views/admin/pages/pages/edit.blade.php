...
<div class="right_col" role="main">
    <form action="{{route('postEditPageAdmin', ['id'=>$page->id])}}" method="POST" class="form-horizontal form-label-left">
    <div class="x_panel">
        <div class="x_title">
            ...
            <br />
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input name="txtTitle" value="{{$page->title}}" type="text" class="add-pages-title form-control required" required="required">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Nội Dung Của Trang</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <textarea name="content" id="ckeditor" class="form-control col-md-7 col-xs-12">{!!$page->content!!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <label>
                            <input @if($page->status=='active') checked @endif value="active" type="radio" class="flat" name="status"> Hoạt Động
                        </label><br>
                        <label>
                            <input @if($page->status=='inActive') checked @endif value="inActive" type="radio" class="flat" name="status"> Không Hoạt Động
                        </label>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="x_content collapse data-optional">
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input value="{{$seo_data['title']}}" type="text" name="txtSeoTitle" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input value="{{$seo_data['description']}}" type="text" name="txtSeoDescription" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input value="{{$seo_data['keywords']}}" type="text" name="txtSeoKeywords" class="form-control">
